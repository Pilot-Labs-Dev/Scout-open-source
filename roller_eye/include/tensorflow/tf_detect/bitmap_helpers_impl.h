...
#ifndef TENSORFLOW_LITE_EXAMPLES_TF_DETECT_BITMAP_HELPERS_IMPL_H_
#define TENSORFLOW_LITE_EXAMPLES_TF_DETECT_BITMAP_HELPERS_IMPL_H_
...
void resize(T* out, uint8_t* in, int image_height, int image_width,
            ...
            int wanted_channels, roller_eye::Settings* s) {
...
#endif  // TENSORFLOW_LITE_EXAMPLES_TF_DETECT_BITMAP_HELPERS_IMPL_H_
